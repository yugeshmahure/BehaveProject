...
class BasePage:
    ...
    def click(self, locator):
        ...
        if str(locator).endswith("_XPATH"):
            ...
            self.driver.find_element_by_class_name(configReader.readConfig("locators", locator)).click()
    ...
    def type(self, locator, value):
        if str(locator).endswith("_XPATH"):
            ...
            self.driver.find_element_by_class_name(configReader.readConfig("locators", locator)).send_keys(value)
